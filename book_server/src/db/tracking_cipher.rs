...
use crate::db::types::EscrowTrackingCipherRow;

impl DBService {
    #[allow(clippy::too_many_arguments)]
    pub async fn upsert_escrow_tracking_cipher(
        &self,
        escrow_pda: &str,
        buyer_pubkey: &str,
        seller_pubkey: &str,
        ...
        sqlx::query(
            r#"INSERT INTO escrow_tracking_ciphertexts
    ...
    pub async fn get_escrow_tracking_cipher(
        &self,
        escrow_pda: &str,
    ) -> Result<Option<EscrowTrackingCipherRow>, sqlx::Error> {
        sqlx::query_as::<_, EscrowTrackingCipherRow>(
            r#"SELECT escrow_pda, buyer_pubkey, seller_pubkey,
               ...
               FROM escrow_tracking_ciphertexts
               WHERE escrow_pda = $1"#,
        )
        .bind(escrow_pda)
